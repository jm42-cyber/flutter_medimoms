                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _buildQuickAction('Maternal Record', Icons.pregnant_woman, const Color(0xFFF59E0B), '/maternal-care'),
                        _buildQuickAction('Family Planning', Icons.family_restroom, const Color(0xFF3B82F6), '/family-planning'),
                        _buildQuickAction('Senior Care', Icons.elderly, const Color(0xFFEC4899), '/senior-citizen'),
                      ],
                    ),
                    const SizedBox(height: 32),
                    Row(
